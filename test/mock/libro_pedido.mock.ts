...
import { CreateProp, EditarProp, GetIdProp } from "@src/base/interface/base.interface";
...
export const mockLibroPedidoService = {
  ...
  getDatoByIdOrFail: jest.fn<(params: GetIdProp<LibroPedido>) => Promise<LibroPedido>>(),
};